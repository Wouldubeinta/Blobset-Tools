...
namespace Pfim
{
    ...
    {
        internal static readonly CompressedTarga Instance = new();

        private unsafe byte[] FastPass(byte[] data, ArraySegment<byte> arr, TargaHeader header, int stride, long arrPosition)
        {
