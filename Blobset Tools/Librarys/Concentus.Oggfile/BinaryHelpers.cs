namespace Concentus.Oggfile
{
    internal static class BinaryHelpers
    {
        ...
        {
            int returnVal = 0;
            returnVal |= source[offset + 3] << 24;
            returnVal |= source[offset + 2] << 16;
            returnVal |= source[offset + 1] << 8;
            returnVal |= source[offset + 0] << 0;
            return returnVal;
        }
        ...
        {
            int returnVal = 0;
            returnVal |= source[3] << 24;
            returnVal |= source[2] << 16;
            returnVal |= source[1] << 8;
            returnVal |= source[0] << 0;
            return returnVal;
        }
        ...
        {
            int returnVal = 0;
            returnVal |= source[offset + 0] << 24;
            returnVal |= source[offset + 1] << 16;
            returnVal |= source[offset + 2] << 8;
            returnVal |= source[offset + 3] << 0;
            return returnVal;
        }
        ...
        {
            int returnVal = 0;
            returnVal |= source[0] << 24;
            returnVal |= source[1] << 16;
            returnVal |= source[2] << 8;
            returnVal |= source[3] << 0;
            return returnVal;
        }
