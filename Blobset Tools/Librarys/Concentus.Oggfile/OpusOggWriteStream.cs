...
namespace Concentus.Oggfile
{
    ...
    public class OpusOggWriteStream
    {
        ...
        private readonly int _encoderSampleRate;

        // Ogg page parameters
        private readonly short[] _opusFrame;
        private readonly int _opusFrameSamples;
        private int _opusFrameIndex;
        private readonly byte[] _currentHeader = new byte[400];
        private readonly byte[] _currentPayload = new byte[65536];
        private int _headerIndex = 0;
        private int _payloadIndex = 0;
        private int _pageCounter = 0;
        private readonly int _logicalStreamId = 0;
