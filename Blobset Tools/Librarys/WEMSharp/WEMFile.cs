...
namespace WEMSharp
{
    public class WEMFile
    {
        ...
        {
            _wemFile = File.OpenRead(fileLocation);

            using (BinaryReader br = new(_wemFile, Encoding.UTF8, true))
            {
        ...
        private void GenerateOGGHeaderTriad(OggStream ogg)
        {
            ...
            //Information Packet
            {
                Packet8 informationPacket = new(_wemFile, offset);
            ...
            //Comment Packet
            {
                Packet8 commentPacket = new(_wemFile, offset);
            ...
            //Setup Packet
            {
                Packet8 setupPacket = new(_wemFile, offset);
        ...
        private void GenerateOGGHeader(OggStream ogg, string codebooksLocation, bool inlineCodebooks, bool fullSetup, ref bool[] modeBlockFlag, ref uint modeBits)
        {
            ...
            //Setup Packet
            {
                ...
                Packet setupPacket = new(_wemFile, _dataChunkOffset + _setupPacketOffset, _noGranule);
                ...
                {
                    CodebookLibrary codebook = new(codebooksLocation);
